...
namespace Plugins
{
    public static partial class Assimp
    {
        ...
        [DllImport(AI_DLL_NAME, CallingConvention = CallingConvention.StdCall, EntryPoint = "aiMaterial_GetTexture", ExactSpelling = false)]
        static extern IntPtr _aiMaterial_GetTexture(IntPtr pScene, int Layer, int type);
        ...
        [DllImport(AI_DLL_NAME, CallingConvention = CallingConvention.StdCall, EntryPoint = "aiMaterial_GetTexture", ExactSpelling = false)]
        static extern IntPtr _aiMaterial_GetName(IntPtr pScene, int Layer);
        ...
        [DllImport(AI_DLL_NAME, CallingConvention = CallingConvention.StdCall, EntryPoint = "aiMesh_GetName", ExactSpelling = false)]
        static extern IntPtr _aiMesh_GetName(IntPtr pScene, int mesh);
        ...
        [DllImport(AI_DLL_NAME, CallingConvention = CallingConvention.StdCall, ExactSpelling = true)]
        ...
        [DllImport(AI_DLL_NAME, CallingConvention = CallingConvention.StdCall, EntryPoint = "aiMesh_GetBoneName", ExactSpelling = false)]
        static extern IntPtr _aiMesh_GetBoneName(IntPtr pScene, int mesh, int Index);
        ...
        [DllImport(AI_DLL_NAME, CallingConvention = CallingConvention.StdCall, EntryPoint = "aiAnim_GetName", ExactSpelling = false)]
        static extern IntPtr _aiAnim_GetName(IntPtr pScene, int anim);
        public static string aiAnim_GetName(IntPtr pScene, int anim) {
            return getString(_aiAnim_GetName(pScene, anim));
        }

        [DllImport(AI_DLL_NAME, CallingConvention = CallingConvention.StdCall, EntryPoint = "aiAnim_GetChannelName", ExactSpelling = false)]
        static extern IntPtr _aiAnim_GetChannelName(IntPtr pScene, int anim, int Index);
        ...
        [DllImport(AI_DLL_NAME, CallingConvention = CallingConvention.StdCall, EntryPoint = "aiNode_GetName", ExactSpelling = false)]
        static extern IntPtr _aiNode_GetName(IntPtr pNode);
