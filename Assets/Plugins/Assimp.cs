...
namespace Plugins {
  ...
  public static partial class Assimp {
    //const string _base_dll_path = "/home/heider/Projects/UnityAssimp/Assets/Plugins/";
    const string AI_BASE_DLL_PATH = "";
    ...
    static Assimp() {
      ...
      #if UNITY_EDITOR_32
        _base_dll_path = Application.dataPath +
 ...
 "x86";
      ...
      _base_dll_path = Application.dataPath
                    ...
                    + "x86_64";
      #else // Player
        _base_dll_path = Application.dataPath + Path.DirectorySeparatorChar + "Plugins";
      #endif

      if (currentPath != null && currentPath.Contains(_base_dll_path) == false) {
        Environment.SetEnvironmentVariable(
            "PATH",
            currentPath + Path.PathSeparator + _base_dll_path, EnvironmentVariableTarget.Process);
      }
      */
    }

    public const string _MenuPath = "Tools/Assimp/";
